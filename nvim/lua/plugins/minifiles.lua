	...
	config = function()
		require("mini.files").setup({
			...
			options = {
				...
				-- Use trash instead of permanent delete for safety (prevents data loss)
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function()
				...
				-- copy current file fullpath to clipboard
		...
		vim.api.nvim_set_hl(0, 'MiniFilesTitle', { bg = 'none' })                        -- Ensures MiniFiles title bar is transparent
