...
static const char *colors[][3]      = {
	...
	[SchemeStatus]   = { col_gray3, "#000000", col_cyan  }, // Statusbar right {text,background,not used but cannot be empty}
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_d,      spawn,          SHCMD("~/.config/rofi/scripts/launcher_t7") },
	{ MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("zen-beta") },
